...
ALTER TABLE Person ADD CONSTRAINT Person_fk1 FOREIGN KEY (department_id) REFERENCES Container(id);
ALTER TABLE Person ADD CONSTRAINT Person_fk2 FOREIGN KEY (curator_id) REFERENCES Person(person_id);
ALTER TABLE Person ADD CONSTRAINT Person_fk3 FOREIGN KEY (group_id) REFERENCES Container(id);
/
...
ALTER TABLE LessonsPlan ADD CONSTRAINT LessonsPlan_fk2 FOREIGN KEY (group_id) REFERENCES Container(id);
/
