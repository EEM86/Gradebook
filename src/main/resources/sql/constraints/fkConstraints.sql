...
ALTER TABLE L3G3_Person ADD CONSTRAINT Person_fk1 FOREIGN KEY (department_id) REFERENCES L3G3_Container(person_id);
ALTER TABLE L3G3_Person ADD CONSTRAINT Person_fk2 FOREIGN KEY (curator_id) REFERENCES L3G3_Person(person_id);
ALTER TABLE L3G3_Person ADD CONSTRAINT Person_fk3 FOREIGN KEY (group_id) REFERENCES L3G3_Container(person_id);
/
...
ALTER TABLE L3G3_LessonsPlan ADD CONSTRAINT LessonsPlan_fk2 FOREIGN KEY (group_id) REFERENCES L3G3_Container(person_id);
/
