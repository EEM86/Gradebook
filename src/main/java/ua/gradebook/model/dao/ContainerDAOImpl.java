...
public class ContainerDAOImpl implements DAO<Container> {
    ...
    private static final String FIND_ALL =
            "SELECT c.ID, c.PARENT_ID, c.NAME, p.FIRST_NAME, p.LAST_NAME, b.TYPE_NAME, c.INSTITUTION_CITY, c.INSTITUTION_ADDRESS, c.PHONE FROM " + TABLE + " c " +
    ...
    private static final class NewRowMapper<P> implements RowMapper<Container> {
        ...
        public Container mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            BranchType type = (new BeanPropertyRowMapper<>(BranchType.class)).mapRow(resultSet, i);
            ...
            container.getType().setTypeName(resultSet.getString(6));
            container.setInstitutionCity(resultSet.getString(7));
            container.setInstitutionAddress(resultSet.getString(8));
            container.setPhone(resultSet.getString(9));
            return container;
        }
    }
}
